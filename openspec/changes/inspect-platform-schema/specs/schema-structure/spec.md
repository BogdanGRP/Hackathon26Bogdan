...
#### Scenario: Table with no explicit PK constraint
- **WHEN** a table has no primary key constraint defined
- **THEN** this is flagged explicitly in the structure catalog
